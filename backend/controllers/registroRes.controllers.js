...
registroResControllers.signup = async (req, res) => {
  ...
  const {namerestaurante, nit, adress, local, phone, email, password, role} = req.body;
  ...
  if (registroResExists) {
    ...
    console.log(role);
    const newregistroRes = new RegistroRes({ namerestaurante, nit, adress, local, phone, email, password, role});
